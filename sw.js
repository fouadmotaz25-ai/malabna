const CACHE='nextmove-app-v33';
const SHELL=['./','./index.html','./training.html','./training.css','./store.html','./nutrition.html','./style.css','./portal-pages.css','./manifest.webmanifest','./nextmove-logo.png'];
